...
const resolvedProviderModels = resolveProviderModels(process.env, llmProvider);
...
const config = {
  ...
  llmProvider,
  llmApiKey: getProviderApiKey(process.env, llmProvider),
  llmTextModel: resolvedProviderModels.textModel,
  llmVisionModel: resolvedProviderModels.visionModel,
  llmSummaryModel: resolvedProviderModels.summaryModel,
  llmRequestedVisionModel: resolvedProviderModels.requestedVisionModel || "",
  llmUsedVisionFallback: Boolean(resolvedProviderModels.usedVisionFallback),
  llmMaxOutputTokens: parseNumber(process.env.LLM_MAX_OUTPUT_TOKENS, 700),
